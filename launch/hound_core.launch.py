...
def _build_fcu_control_node(
    ...
    params = {
        ...
        "vslam_pos_sigma_m": float(fc.get("vslam_pos_sigma_m", 0.1)),
        "vslam_yaw_sigma_rad": float(fc.get("vslam_yaw_sigma_rad", 0.1)),
        "vslam_vel_sigma_mps": float(fc.get("vslam_vel_sigma_mps", 0.2)),
